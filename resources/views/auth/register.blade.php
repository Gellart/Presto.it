            ...
            <div class="container py-5 h-100">
                <div class="row d-flex align-items-center justify-content-center h-100">
                    <div class="col-md-8 col-lg-7 col-xl-6 ">
                        <img src="{{ URL::to('/') }}/images/register.png" class="img-fluid" alt="Phone image">
                    </div>
                        ...
                        <form action="/register" method="post" class="custom-form contact-form" role="form">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" name="name" id="name"
                                    class="form-control rounded-2 border-0 px-4 shadow" placeholder="Mario Rossi" />
                            </div>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="email" name="email" id="email"
                                    class="form-control rounded-2 border-0 px-4 shadow"
