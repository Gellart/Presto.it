        ...
        <div class="row">
            <div class="col-12">
                <div class="col-12 text-center">
                    <h2 class="display-2 mb-5">Crea una nuova password</h2>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form action="/reset-password" method="post">
                            ...
                            <input class="form-control mb-3" type="password" name="password_confirmation"
                                id="password_confirmation" placeholder="Conferma Passsword">
                            <!--  token hidden -->
                            <input class="form-control mb-3" type="hidden" name="token"
